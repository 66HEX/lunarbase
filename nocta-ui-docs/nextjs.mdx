...
- **Framework Detection**: Automatically detect that you're using Next.js and determine if you're using App Router or Pages Router
...
- **Project Structure**: Create the `components/ui/` directory structure for components
- **Utils Setup**: Generate `lib/utils.ts` with the necessary utility functions
