...
export const DialogFooter: React.FC<DialogFooterProps> = ({
	...
	return (
		<div
			className={cn(
				"px-6 py-4 bg-nocta-200/50 dark:bg-nocta-800/30 border-t border-nocta-200 dark:border-nocta-800/50 rounded-b-xl flex items-center justify-end not-prose",
				className,
			)}
			{...props}
		>
